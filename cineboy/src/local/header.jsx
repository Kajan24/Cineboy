...
export default function Header() {
    ...
    return (
        <>
            <header className="w-full pl-2 pr-2 flex items-center justify-between h-16 lg:h-28 mx-auto mt-5 sticky top-0 bg-black/40 backdrop-blur-3xl z-50 rounded-md">
